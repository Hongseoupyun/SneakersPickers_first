          ...
          <div className="about-us-description ">
            <div className="about-us-text">
              ...
              <span>
                ...
                created the Random Paragraph Generator with you in mind. The
                ...
                paragraphs will instantly appear.
              </span>
            </div>
            <span className="about-image">
              <img src={tradingaboutus} alt="" width="800px" height="700x" />
            </span>
          </div>
        </article>
            ...
            <div className="card">
              ...
              <div className="card-body">
                ...
                <p className="card-text">
                  Full-stack developer. CEO of this website.
                </p>
                <a href="https://github.com/nktrancs">
                  <img
                    ...
                    height="50x"
                    width="50px"
                    href="https://github.com/bhinder97"
                    target="_blank"
                  />
                </a>
